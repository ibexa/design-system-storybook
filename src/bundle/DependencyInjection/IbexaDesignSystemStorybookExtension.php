...
namespace Ibexa\Bundle\DesignSystemStorybook\DependencyInjection;
...
final class IbexaDesignSystemStorybookExtension extends Extension implements PrependExtensionInterface
{
    /**
